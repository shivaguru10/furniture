    ...
    <div class="modal-overlay" id="modal-overlay">
      <div class="modal-content glass">
        ...
        <div class="auth-header">
          ...
          <p>${type === 'login' ? 'Welcome back to Gugan Furniture' : 'Create an account to start shopping'}</p>
        </div>
        ...
        <div class="auth-footer">
          ${type === 'login'
            ? `New to Gugan Furniture? <button id="switch-to-signup">Create Account</button>`
